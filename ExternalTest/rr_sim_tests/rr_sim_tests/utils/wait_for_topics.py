...
# Foxy does not have this util yet
# https://github.com/ros2/launch_ros/blob/master/launch_testing_ros/launch_testing_ros/wait_for_topics.py
class WaitForTopics:
    """
    ...
    def __init__(self, in_topic_tuples, in_timeout=5.0):
        self.topic_tuples = in_topic_tuples
