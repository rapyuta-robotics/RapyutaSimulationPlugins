...
void ARRBaseRobotROSController::OnPossess(APawn* InPawn)
{
    ...
    else
    {
        UE_LOG(LogRapyutaCore,
                Warning,
                TEXT("[%s][ARRBaseRoboROSController::OnPossess] Pawn is not child class of ARRBaseRobot "), *GetName());
    }
}
...
void ARRBaseRobotROSController::OnUnPossess()
{
    ...
    else
    {
        UE_LOG(LogRapyutaCore,
                Warning,
                TEXT("[%s][ARRBaseRobotROSController::OnUnPossess] Pawn is not child class of ARRBaseRobot "), *GetName());
    }
    Super::OnUnPossess();
}
