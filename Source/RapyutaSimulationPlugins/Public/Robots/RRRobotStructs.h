...
public:
    ...
    static FRRRobotWheelProperty ComposeWheelProperty(FString InWheelName)
    {
        ...
        wheelProp.WheelWidth = bFrontWheel ? 10.f : 20.f;
        ...
        // [Spring]
        wheelProp.SpringRate = 100.f;
        wheelProp.SpringPreload = 10.f;
...
/**
 * @brief  This class will co-parent with [IFastXmlCallback], which is not a USTRUCT,  thus it could not be also either.
 * 
 */
