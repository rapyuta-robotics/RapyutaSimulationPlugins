...
#include "RRRobotROSController.generated.h"
...
class RAPYUTASIMULATIONPLUGINS_API ARRRobotROSController : public AAIController
{
    GENERATED_BODY()
...
protected:
    ...
    void SubscribeToJointTrajControllerStatesTopic(const FString& InTopicName);
    virtual void JointTrajectoryControllerStateCallback(const UROS2GenericMsg* Msg)
    {
        checkNoEntry();
    }
