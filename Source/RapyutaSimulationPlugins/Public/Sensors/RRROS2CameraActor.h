 ...
 * @brief Standalone ROS 2 Camera actor formed by #URRROS2CameraComponent
...
/**
 * @brief Standalone ROS 2 camera actor which can be placed in the level with #URRROS2CameraComponent.
 */
UCLASS()
...
protected:
    /**
     * @brief Initialize ROS 2 Node and #CameraComponent
     * If NodeName is empty, node name become This actor name + _RRROS2CameraNode
     */
    virtual void BeginPlay() override;

    //! ROS 2 camera component for this camera
